               ...
               <div className="p-6">
                 ...
                 <div className="flex items-center flex-wrap ">
                   ...
                   <span className="text-gray-400 mr-3 inline-flex items-center lg:ml-auto md:ml-0 ml-auto leading-none text-sm pr-3 py-1 border-r-2 border-gray-200">
                     <svg className="w-4 h-4 mr-1" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
...
<input value={search} onChange={(e)=>setsearch(e.currentTarget.value)} type="search" placeholder='Search here' className='border-2 outline-none p-3 w-80 '/>
<button onClick={()=>searchbtn()} className='bg-purple-900 text-white px-10 py-3 border-r-3'>Search</button>
</div>
{search == ""?"":<h3 className='text-xl text-center mb-7'>you search {search}</h3>}
<div className="flex flex-wrap -m-4">
